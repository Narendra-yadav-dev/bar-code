...
<div class="content-wrapper">
    ...
    <div class="row tickets_grid_margi">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img src="{{ asset('public/images/faces/face1.jpg') }}" class="me-2" alt="image"> David Grey
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('public/images/faces/face1.jpg') }}" class="me-2" alt="image"> Stella Johnson
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('public/images/faces/face3.jpg') }}" class="me-2" alt="image"> Marina Michel
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{ asset('public/images/faces/face4.jpg') }}" class="me-2" alt="image"> John Doe
                                    </td>
